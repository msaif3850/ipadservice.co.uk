        ...
        <>
            <div className="px-6 py-24 sm:py-22 lg:px-8">
                <div className="mx-auto max-w-5xl text-center">
                    <h1 className="text-5xl font-semibold tracking-tight text-gray-950 sm:text-7xl">Delivering iPad repairs within 40 minutes by certified technicians covering the leeds & bradford area</h1>
                    <h2 className="mt-8 text-pretty text-lg text-gray-600 sm:text-xl/8">We have become market leaders setting the highest standards for quality repairs
                        within the hour restoring your treasured iPads</h2>
                </div>
            </div>
                ...
                <div className="mt-20">
                    <div className="flex flex-col lg:flex-row items-center">
                        ...
                        <div className="w-full lg:w-1/2 mt-10 lg:mt-0 lg:pl-10 space-y-5 text-center lg:text-left">
                            ...
                            <p className="text-lg">We are intimately familiar with the mac mini, we are servicing and
                                repairing this device since its first release in 2005. We can easily upgrade the memory
                                (RAM) and storage (Hard Drive - SSD) of the mac mini same day as our 1500sqft premises
                                stockpile replacement part for this device. We can also bring your Mac Mini back to life
                                with a logic board repair! We provide the in-depth repair service other technicians
                                cannot. Component level repair is our speciality. Our technicians are trained and
