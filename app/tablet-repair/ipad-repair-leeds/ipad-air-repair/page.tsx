...
const products = [
    ...
    },
    {
        ...
        image: "/products/tablets/google-nexus-tablet.jpg",
...
export default function TabletRepair() {
    ...
    return (
        <>
            ...
            <section className="px-10 py-20 text-center bg-gray-100">
                <h2 className="text-3xl mb-6">We have exceled in becoming market leader in the repair industry.</h2>
